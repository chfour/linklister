...
def recurse_find(url: str, file, verbose=False, user_agent=DEFAULT_USERAGENT):
...
if __name__ == "__main__":
    ...
    with output:
        recurse_find(args.start_url, output, verbose=(not args.quiet), user_agent=args.user_agent)
